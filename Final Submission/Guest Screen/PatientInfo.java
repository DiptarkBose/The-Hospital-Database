...
public class PatientInfo {
    ...
    public void connect(int id) {
        ...
        try {
            ...
            ResultSet resultSet = st.executeQuery("SELECT * from Patient where PatientID="+id);
    ...
    public PatientInfo() {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                JFrame frame = new JFrame("Patient Information Portal");
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            add(new JLabel("Enter Patient ID for accessing the records"), gbc);
            gbc.gridx = 0;
            gbc.gridy++;
            ...
            gbc.gridx=0;
            gbc.gridy++;
            add(new JLabel("Required Patient Information:"), gbc);
            gbc.gridy++;
            gbc.gridy++;
            gbc.gridx=0;
