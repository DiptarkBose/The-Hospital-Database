...
public class NurseChanges {
    ...
    public void connect(int e_id, String e_name, int room) {
        ...
        try {
            ...
            String str = ("insert into Nurse values("+e_id+",'"+e_name+"',"+room+")");
    ...
    public void connectdel(int pat_id) {
        ...
        try {
            ...
            String str = ("delete from Nurse where EmployeeID="+pat_id);
            st.executeUpdate(str);
        } catch (Exception ex) {
        }
    }
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            add(new JLabel("Enter Nurse's Information for adding to the records"), gbc);
            gbc.gridx = 0;
            gbc.gridy++;
            add(new JLabel("Nurse ID"), gbc);
            gbc.gridx++;
            add(new JLabel("Nurse Name"), gbc);
            gbc.gridx++;
            add(new JLabel("Governs Room"), gbc);
            gbc.gridx++;
            ...
            gbc.gridy++;
            gbc.gridx = 1;
            add(new JLabel("Enter Nurse ID for deleting a record"), gbc);
            gbc.gridy++;
            gbc.gridx = 0;
