...
public class BlockChanges {
    ...
    public void connect(int d_id, String d_name) {
        ...
        try {
            ...
            String str = ("insert into Block values("+d_id+",'"+d_name+"')");
    ...
    public BlockChanges() {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                JFrame frame = new JFrame("Add a Block");
    ...
    public class TestPane extends JPanel {
        ...
        public TestPane() {
            ...
            add(new JLabel("Enter Block Details for adding to records"), gbc);
            gbc.gridx = 0;
            gbc.gridy++;
            add(new JLabel("Block ID"), gbc);
            gbc.gridx++;
            add(new JLabel("Block Name"), gbc);
            gbc.gridx++;
